...
$(document).ready(function () {
  ...
  oTarget.not(":first").each(function () {
    $(this)
      ...
      .wrap(function () {
        return (
          '<p class="thumbnail">' + $(this).html() + oAppend.html() + "</p>"
        );
      });
...
$(
  ".xans-product-detail .ec-base-table.typeWrite td select option:first-child"
).text("옵션");
...
const accCon = $(".xans-product-additional .faq .contents");
const accTit = $(".xans-product-additional .faq .title");
const accTitIcon = $(".xans-product-additional .faq .title i");
const ACTIVE = 'active';

accCon.hide();
accTit.click(function () {
  if (accTitIcon.hasClass(ACTIVE) !== true || $(this).children(".xans-product-additional .faq .title i").hasClass(ACTIVE) === true) {
    $(this).children(".xans-product-additional .faq .title i").toggleClass(ACTIVE);
  } else {
    accTitIcon.removeClass(ACTIVE);
    $(this).children(".xans-product-additional .faq .title i").toggleClass(ACTIVE);
  }

  accCon.not($(this).next(accCon).slideToggle()).slideUp();
});
